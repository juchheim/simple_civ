...
export const CITY_STATE_INVEST_SUZERAIN_RAMP_CAP = 6;
...
export const BUILDINGS: Record<BuildingType, BuildingData> = {
    ...
    [BuildingType.TradingPost]: { era: EraId.Hearth, techReq: TechId.Fieldcraft, cost: 40, yieldFlat: { G: 3 }, maintenance: 2, rushBuyDiscountPct: 5, conditional: "+1 Gold per 3 population (shared with Market Hall; applies once per city)" },
    ...
    [BuildingType.MarketHall]: { era: EraId.Banner, techReq: TechId.Wellworks, cost: 56, yieldFlat: { G: 4 }, maintenance: 3, rushBuyDiscountPct: 10, requiresBuilding: BuildingType.TradingPost, conditional: "+1 Gold per 3 population (shared with Trading Post; applies once per city)" },
    ...
    [BuildingType.Exchange]: { era: EraId.Engine, techReq: TechId.SignalRelay, cost: 108, yieldFlat: { G: 4 }, maintenance: 5, rushBuyDiscountPct: 20, requiresBuilding: BuildingType.Bank },
