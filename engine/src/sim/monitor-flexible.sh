...
run_analysis "Command Points" "engine/src/sim/analyze-command-points.mjs" "optional"
...
copy_report "/tmp/cp-analysis-report.md" "$REPORTS_DIR/cp-analysis-report.md" "optional"
