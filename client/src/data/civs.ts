...
export const CIV_OPTIONS: CivOption[] = [
    {
        ...
        perk: "+1 Prod/Hill (Capital) • +1 Prod/Sci for Industrial Bldgs • 20% Cheaper Military • Hill City Units: +2 Atk • +1 Atk per Engine Tech",
        color: "#f97316",
    },
    {
        id: "ScholarKingdoms",
        ...
        perk: "+1 Science per City Ward • Unique Unit: Lorekeeper • Unique Building: Bulwark",
        color: "#0ea5e9",
    },
    {
        id: "RiverLeague",
        ...
        perk: "+1 Food/River Tile • +1 Prod per 2 River Tiles • +1 Atk (All Units) • +2 Atk/Def near Rivers • +2 Atk vs Cities",
        color: "#A0522D",
    },
    {
        ...
        perk: "+1 Prod (Garrisoned Cities) • +1 Defense (All Units) • Science on Kills • +1 Move if Titan is alive • Unique: Titan",
        color: "#9333ea",
    },
    {
        id: "StarborneSeekers",
        ...
        perk: "+1 Science (Capital) while at Peace • Unique Unit: Lorekeeper • Unique Building: Bulwark",
        color: "#1e3a8a",
    },
    {
        id: "JadeCovenant",
        ...
        perk: "+1 Atk/Def per 20 Pop • 5% Faster Growth • Settlers: +2 Def & 2 Moves • Nature's Wrath: Enemies in territory take 1 Dmg/Turn • Unique: Jade Granary",
        color: "#0f9d58",
    },
];
