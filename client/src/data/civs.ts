...
export const CIV_OPTIONS: CivOption[] = [
    ...
    },
    {
        ...
        perk: "+1 Science (Capital) • +1 Science/City Ward • +8 Defense (split near cities) • Starts w/extra Bow Guard • Unique: Lorekeeper, Bulwark",
        color: "#0ea5e9",
    },
    {
        id: "RiverLeague",
        ...
        perk: "+1 Food/river • +1 Prod/2 rivers • +1 Atk (all) • +2 Atk/+2 Def near rivers • +2 Atk vs cities",
        color: "#A0522D",
    },
    {
    ...
    },
    {
        ...
        perk: "+1 S (Capital) at peace • +1 Defense (all) • Starts w/extra Scout • Unique: Spirit Observatory, Lorekeeper, Bulwark",
        color: "#1e3a8a",
    },
    {
        id: "JadeCovenant",
