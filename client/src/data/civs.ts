...
export const CIV_OPTIONS: CivOption[] = [
    ...
    },
    {
        ...
        perk: "+1 Science (Capital) • +1 Science/CityWard • +8 Defense (split across cities) • Unique: Lorekeeper, Bulwark",
        color: "#0ea5e9",
    },
    {
        id: "RiverLeague",
        ...
        perk: "+1 Food/river tile • +1 Prod/2 river tiles • +2 Atk/+2 Def near rivers • +2 Atk vs cities",
        color: "#A0522D",
    },
    {
        ...
        perk: "+1 Prod w/ garrison • Science on kills • Unique: Titan's Core (spawns Titan)",
        color: "#9333ea",
    },
    {
        id: "StarborneSeekers",
        ...
        perk: "+1 Science/city at peace • +1 Defense everywhere • Unique: Spirit Observatory, Lorekeeper, Bulwark",
        color: "#1e3a8a",
    },
    {
        id: "JadeCovenant",
