...
export const CIV_OPTIONS: CivOption[] = [
    ...
    },
    {
        ...
        perk: "+1 Food per river tile • +1 Prod per 3 river tiles • Units near rivers +1 Atk/+1 Def",
        color: "#A0522D",
    },
    {
    ...
    },
    {
        ...
        perk: "Starts with Scout + SpearGuard • +1 Defense (everywhere) • +1 Science per Academy • Spirit Observatory (220)",
        color: "#1e3a8a",
    },
    {
        id: "JadeCovenant",
