...
- **Unlocks**:
  ...
  - Signal Relay (200) → +2 Science per city (passive; also unlocks the Exchange tier of the gold-building chain after Bank).
...
- Costs are Production; one per city unless noted.
  ...
  - Gold-building stacking rule: a city's first gold building gives full listed gold, then additional gold buildings in that city give reduced listed-gold returns (45%, 20%, then 10%, rounded, minimum 1). Rush-buy discounts and supply bonuses still apply normally.
  - Trading Post and Market Hall share one commercial population bonus per city: `+floor(pop / 3)` Gold applied once to the first gold-building slot in that city.
  ...
  - **Trading Post** (40, Fieldcraft): +3 Gold, 2 upkeep; shares the per-city commercial population bonus; rush-buy discount 5%.
    - Tactical role: first commercial foothold, focused on gold rather than military support.
  - **Market Hall** (56, Wellworks, requires Trading Post): +4 Gold, 3 upkeep; shares the per-city commercial population bonus; +1 free supply; rush-buy discount 10%.
    - Tactical role: mid-tier commerce upgrade that improves the host city without creating cross-city gold spillover.
  ...
  - **Exchange** (108, Signal Relay, requires Bank): +4 Gold, 5 upkeep; +2 free supply; rush-buy discount 20%.
    - Tactical role: capstone commerce upgrade for cities that fully commit to the chain.
