SIMPLE CIV — v0.9 RULEBOOK / DESIGN DOC
Table of Contents
...
A Settler on a tile may be captured by an enemy military unit entering the tile.
If at peace, this immediately declares war.
Capturing player gains a new Settler on that tile.
...
City HP resets to 10 immediately.

City loses 1 Pop (min 1).

All buildings remain and function normally.
...
At the end of each global round, any civ controlling 0 cities is eliminated.

Before elimination, a civ with 0 cities may still act during the round.
